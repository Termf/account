...
public interface UserFaceApi {
     ...
     * @return
     */
    @ApiOperation("WEB端私有云人脸识别验证结果")
    @PostMapping("/web/faceVerify/private")
    APIResponse<Void> pcFaceVerifyPrivate(@Validated @RequestBody APIRequest<FacePcPrivateResult> request);
