...
public interface SubUserApi {
    ...
    @ApiOperation("查询母账号下所有子账号的期货subUserBinding")
    @PostMapping("/queryFutureSubUserBinding")
    APIResponse<List<SubUserBindingVo>> queryFutureSubUserBinding(@RequestBody APIRequest<IdRequest> request) throws Exception;

    @ApiOperation("检查并查询母账号的子账号userInfo")
    @PostMapping("/checkParentAndGetSubUserInfoList")
    APIResponse<List<UserInfoVo>> checkParentAndGetSubUserInfoList(@RequestBody APIRequest<CheckParentAndGetSubUserInfoListRequest> request) throws Exception;

    @ApiOperation("检查并查询母账号的userInfo")
    @PostMapping("/checkParentAndGetUserInfo")
    APIResponse<UserInfoVo> checkParentAndGetUserInfo(@RequestBody APIRequest<IdRequest> request) throws Exception;

    @ApiOperation("检查母子账号绑定关系，并返回子账号userVo")
    @PostMapping("/checkParentAndSubUserBinding")
    APIResponse<UserVo> checkParentAndSubUserBinding(@RequestBody APIRequest<CheckParentAndSubUserBindingRequest> request) throws Exception;
}
