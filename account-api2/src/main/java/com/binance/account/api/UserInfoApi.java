...
public interface UserInfoApi {
    ...
    @ApiOperation("根据批次号修改返佣审核状态(同步修改子账户)")
    @PostMapping("/auditAgentStatusByBatchId")
    APIResponse<AuditAgentStatusByBatchIdResponse> auditAgentStatusByBatchId(
            @Validated @RequestBody APIRequest<AuditAgentStatusByBatchIdRequest> request) throws Exception;
    ...
    @ApiOperation("获取用户最后一次登录使用的语言Lang")
    @GetMapping("/getLastLoginLanguage")
    APIResponse<String> getUserLastLoginLanguage(@RequestParam("userId") Long userId) throws Exception;
