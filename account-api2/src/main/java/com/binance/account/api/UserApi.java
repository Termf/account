...
public interface UserApi {
    ...
    @ApiOperation(notes = "修改用户密码", nickname = "updatePwd", value = "修改用户密码")
    @PostMapping("/updatePwdV2")
    APIResponse<UpdatePwdUserV2Response> updatePwdV2(@RequestBody() APIRequest<UpdatePwdUserV2Request> request)
            throws Exception;
    ...
    @ApiOperation("查询用户财务、kyc、资产等状态")
    @PostMapping("/financeFlag")
    APIResponse<FinanceFlagResponse> financeFlag(@RequestBody APIRequest<UserIdReq> request) throws Exception;

    @ApiOperation("查询用户基本信息")
    @PostMapping("/checkAndGetUserById")
    APIResponse<GetUserResponse> checkAndGetUserById(@RequestBody APIRequest<com.binance.account.vo.user.request.UserIdRequest> request) throws Exception;

    @ApiOperation("查询矿池返佣")
    @PostMapping("/selectMiningUserAgentLog")
    APIResponse<SearchResult<SelectUserAgentLogResponse>> selectMiningUserAgentLog(@RequestBody APIRequest<SelectMiningAgentLogRequest> request) throws Exception;

    @ApiOperation("查询矿池返佣数量")
    @PostMapping("/selectMiningUserAgentNum")
    APIResponse<Long> selectMiningUserAgentNum(@RequestBody APIRequest<SelectUserAgentNumRequest> request) throws Exception;
    ...
    // LVT(Leverage tokens) 杠杆代币
    @ApiOperation("用户是否做过LVT调查问卷 ")
    @PostMapping("/queryLVTSurveyStatus")
    APIResponse<UserSAQResponse> queryLVTSurveyStatus(@RequestBody APIRequest<UserIdReq> request) throws Exception;

    // SAQ(short answer questions) 问卷
    @ApiOperation("完成LVT调查问卷状态")
    @PostMapping("/finishLVTSAQ")
    APIResponse<Boolean> finishLVTSAQ(@RequestBody APIRequest<UserIdReq> request) throws Exception;
}
