...
@ApiModel(description = "注册Request", value = "注册Request")
@FieldMatch(first = "password", second = "confirmPassword")
@Getter
@Setter
public class RegisterUserRequest extends ToString {
    ...
    @ApiModelProperty(required = false, notes = "是否需要checkip")
    private Boolean needCheckIp=true;
