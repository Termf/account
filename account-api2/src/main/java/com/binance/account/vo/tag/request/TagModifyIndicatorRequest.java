 ...
 * @date 2018/6/21
 */
@ApiModel("修改用户标签关系Request")
@Getter
@Setter
public class TagModifyIndicatorRequest extends ToString {
    private static final long serialVersionUID = 7997462233131526510L;
    @ApiModelProperty(value = "旧标签ID", required = true)
    @NotEmpty
    private String id;
    @ApiModelProperty(value = "新标签ID", required = true)
