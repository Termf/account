...
public interface UserWckApi {
    ...
    @ApiOperation("分页获取World Check审核列表")
    @PostMapping("/audit/listByPages")
    APIResponse<SearchResult<UserWckAuditVo>> getListByPages(@RequestBody() APIRequest<UserChannelWckQuery> request);
    ...
    APIResponse<?> getChannelWckResultProfile(@RequestParam("caseId") String kycId);
}
