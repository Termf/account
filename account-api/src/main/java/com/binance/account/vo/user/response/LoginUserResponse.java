...
@ApiModel(description = "登录Response", value = "登录Response")
@Getter
@Setter
@NoArgsConstructor
public class LoginUserResponse extends ToString {
    ...
    public LoginUserResponse(Long userId, String email, Long status, AuthStatusEnum authStatus) {
        super();
        this.userId = userId;
