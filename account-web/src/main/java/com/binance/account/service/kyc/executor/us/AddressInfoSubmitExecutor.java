...
import com.binance.account.service.kyc.validator.AddressInfoSubmitValidator;
...
@Service
@Log4j2
public class AddressInfoSubmitExecutor extends AbstractKycFlowCommonExecutor {
	...
	@Autowired
	private AddressInfoSubmitValidator validator;
	...
	private void validateRequest(AddressInfoSubmitRequest request) {
