...
@Component
public class UserIndexTableRule extends TableRuleSharding {

    public UserIndexTableRule() {
        super();
        this.setLogicTable("user_index");
        this.setActualDataNodes("db1.user_index_${0..19}");
