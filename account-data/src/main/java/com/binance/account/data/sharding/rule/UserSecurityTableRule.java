...
@Component
public class UserSecurityTableRule extends TableRuleSharding {

    public UserSecurityTableRule() {
        super();
        this.setLogicTable("user_security");
        this.setActualDataNodes("db1.user_security_${0..19}");
