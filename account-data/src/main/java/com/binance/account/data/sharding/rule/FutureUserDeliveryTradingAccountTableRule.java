...
@Component
public class FutureUserDeliveryTradingAccountTableRule extends TableRuleSharding {

    public FutureUserDeliveryTradingAccountTableRule() {
        super();
        this.setLogicTable("future_user_delivery_trading_account");
        this.setActualDataNodes("db1.future_user_delivery_trading_account_${0..19}");
        // DefaultKeyGenerator.setWorkerId(workerId);
        // 选库规则
        // this.setDatabaseShardingStrategyConfig(new InlineShardingStrategyConfiguration("master_id",
        // "db_${master_id % 2}");
        // 选表规则
        this.setTableShardingStrategyConfig(new StandardShardingStrategyConfiguration("delivery_trading_account",
