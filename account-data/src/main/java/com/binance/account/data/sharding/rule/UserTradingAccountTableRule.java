...
@Component
public class UserTradingAccountTableRule extends TableRuleSharding {

    public UserTradingAccountTableRule() {
        super();
        this.setLogicTable("user_trading_account");
        this.setActualDataNodes("db1.user_trading_account_${0..19}");
