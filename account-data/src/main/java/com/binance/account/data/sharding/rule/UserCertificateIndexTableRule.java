...
@Component
public class UserCertificateIndexTableRule extends TableRuleSharding {

    public UserCertificateIndexTableRule() {
        super();
        this.setLogicTable("user_certificate_index");
        this.setActualDataNodes("db1.user_certificate_index_${0..19}");
        ...
        this.setTableShardingStrategyConfig(
                new StandardShardingStrategyConfiguration("number", new UserTableShardingAlgorithm()));
    }
    ...
    public static class UserTableShardingAlgorithm implements PreciseShardingAlgorithm<String> {
        ...
        // if (StringUtils.equals(shardingValue.getColumnName(), "number")) {// number hash分库
